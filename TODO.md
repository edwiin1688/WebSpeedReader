...
- [x]- **雙重色彩自定義**: 支援自定義「字體顏色」與「背景顏色」。介面按鈕現在會根據字體色自動產生對應的框線，讓整體配色保持一致且優雅。
- **多語系支援擴充**: 新增日語、韓語、法語、德語、西班牙語支援，覆蓋介面文字與 AI 總結輸出。
...
## 🟡 進行中 / 優先開發 (Priority)
- [ ] **摘要長度自定義**: 允許使用者透過滑動條調整總結的精簡程度。

## ⚪ 待辦功能 (Backlog)
- [ ] **快捷鍵支援**: 設定鍵盤快捷鍵以快速觸發總結功能。
